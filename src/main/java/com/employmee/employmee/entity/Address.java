...
public class Address {
	...
	public int hashCode() {
		...
		result = prime * result + ((streetNameNo == null) ? 0 : streetNameNo.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (state == null) {
			...
			return false;
		if (streetNameNo == null) {
			if (other.streetNameNo != null)
				return false;
		} else if (!streetNameNo.equals(other.streetNameNo))
			return false;
		return true;
	}
